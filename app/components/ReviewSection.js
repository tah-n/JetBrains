          ...
          <div className='w-full no-scrollbar scroll-smooth overflow-x-scroll'>
            ...
            <div className='w-fit h-full px-4 lg:w-full flex justify-center gap-4'>
              ...
              {interviews.map((view, i) => (
                <div
                  key={i} 
                  className='rounded-3xl bg-[#6B57FF] text-white w-[470px] sm:w-[400px] lg:w-[25vw] sm:h-[300px] flex flex-col justify-center sm:justify-evenly gap-9 px-4 h-[260px] overflow-hidden'>
                    <p className='z-20'>
                      {view.review}
                    </p>
