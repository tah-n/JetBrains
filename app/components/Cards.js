...
const Cards = ({ className, title, textClass, bg, avatarClassName, desc, button, imgWhite,imgBlue}) => {
  ...
  return (
    ...
    className={`${className} relative sm:w-[42vw] lg:w-[24vw] sm:h-[350px] cursor-pointer text-left bg-white transition-all ease-in-out text-[#19191c] hover:bg-[#6B57FF] hover:text-white pl-6 p-6 flex flex-col items-start justify-center overflow-hidden w-[450px] h-[270px] rounded-3xl`}>
        <motion.div
